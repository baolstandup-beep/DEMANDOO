...
const AnimatedBackground = () => {
  ...
  return (
    <div 
      ref={ref}
      className="fixed inset-0 bg-mesh-pattern opacity-10 pointer-events-none mix-blend-overlay z-0"
...
export const HomePage = () => {
  ...
  return (
    <div className="font-sans bg-gradient-to-b from-[#073444] via-[#07132E] to-[#040B16] text-white relative min-h-screen">
      <AnimatedBackground />

      {/* 2. PREMIER ÉCRAN (Hero Section Premium) */}
      <section className="relative overflow-x-clip min-h-[780px] flex items-center pt-24 pb-16 lg:pt-0 lg:pb-0 border-b border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[52%_48%] items-center justify-center min-h-[780px] gap-12 lg:gap-0">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-7 order-2 lg:order-1 w-full max-w-[720px] mx-auto lg:mx-0">
              ...
              <Reveal delay={400} className="w-full">
                <div className="bg-white/10 backdrop-blur-2xl p-4 sm:p-5 lg:p-6 rounded-[24px] w-full shadow-[0_8px_32px_rgba(0,0,0,0.3)] border border-white/20 relative z-20 transition-transform duration-300 hover:shadow-demandoo-500/20">
                  <form onSubmit={handleSearchSubmit} className="flex flex-col gap-3">
                    
                    {/* VILLES DEPART ET DESTINATION */}
                    <div className="flex flex-col sm:flex-row gap-3 relative">
                      {/* Départ */}
                      <div className="w-full sm:flex-1 flex items-center gap-3 bg-white/5 hover:bg-white/10 focus-within:bg-white/10 focus-within:ring-2 focus-within:ring-white/30 p-3.5 sm:p-4 rounded-2xl transition-all border border-white/10">
                        ...
                        <div className="w-full text-left">
                          ...
                          <input 
                            ...
                            className="w-full bg-transparent font-bold text-white text-sm sm:text-base focus:outline-none placeholder-white/60" 
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex justify-center -my-2 sm:my-0 sm:-mx-3 relative z-10 sm:self-center">
                        <button 
                          ...
                          className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md border border-white/30 shadow-lg flex items-center justify-center hover:bg-white/30 transition-transform hover:scale-110 active:scale-95 group shrink-0"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-white sm:rotate-90">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      {/* Date */}
                      <div className="w-full sm:flex-[2] md:flex-1 flex items-center gap-3 bg-white/5 hover:bg-white/10 focus-within:bg-white/10 focus-within:ring-2 focus-within:ring-white/30 p-3.5 sm:p-4 rounded-2xl transition-all border border-white/10">
                        ...
                        <div className="w-full text-left">
                          ...
                          <input 
                            ...
                            className="w-full bg-transparent font-bold text-white text-sm sm:text-base focus:outline-none placeholder-white/60 [color-scheme:dark]" 
                          />
                        </div>
                      </div>

                      {/* Passagers */}
                      <div className="w-full sm:w-32 flex items-center justify-between sm:justify-center gap-2 bg-white/5 hover:bg-white/10 focus-within:bg-white/10 focus-within:ring-2 focus-within:ring-white/30 p-3.5 sm:p-4 rounded-2xl transition-all border border-white/10">
                        <div className="flex items-center gap-2">
                          <Users className="w-5 h-5 text-white/70 shrink-0" />
                          <span className="sm:hidden text-sm font-bold text-white/80">Passagers :</span>
                        </div>
                        <input 
                          type="number" 
                          min="1" 
                          ...
                          className="w-12 bg-transparent font-bold text-white text-sm sm:text-base focus:outline-none text-right sm:text-center" 
      ...
      {/* PARTENAIRES */}
      <section className="relative py-8 border-b border-white/10 overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-sm font-bold text-white/50 uppercase tracking-widest mb-6 relative z-10">Ils nous font confiance</p>
        </div>
        
        {/* Container pour le défilement (Marquee) */}
        <div className="flex whitespace-nowrap overflow-hidden relative">
          {/* Dégradés sur les bords pour l'effet de fondu */}
          <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#07132E] to-transparent z-10 pointer-events-none"></div>
          <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#07132E] to-transparent z-10 pointer-events-none"></div>
          
          {/* Le contenu animé qui défile */}
          <div className="flex items-center gap-16 md:gap-24 opacity-40 hover:opacity-80 transition-opacity duration-300 w-max pl-16">
            ...
            {[...Array(4)].map((_, arrayIndex) => (
              <React.Fragment key={arrayIndex}>
                {['BAOL OFFICES', 'RESTAURANT MBECKTE MII', 'BAOLVISION', 'TOUBA CA KANAM'].map((partner, i) => (
                  <div key={`${arrayIndex}-${i}`} className="text-2xl font-black text-white/80 tracking-tighter shrink-0 cursor-default">
                    {partner}
                  </div>
                ))}
              </React.Fragment>
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
          <Reveal>
            <h2 className="text-3xl font-black text-white">Trajets disponibles</h2>
          </Reveal>
          <Reveal delay={150}>
            <Link to="/trajets" className="group px-5 py-2.5 rounded-xl bg-white/10 text-white font-bold hover:bg-white/20 border border-white/20 transition-all flex items-center gap-2 backdrop-blur-md">
        ...
        {availableTrips.length === 0 ? (
          <div className="bg-white/10 backdrop-blur-xl p-8 rounded-[2rem] text-center border border-white/20 shadow-lg">
            <h3 className="text-lg font-bold text-white mb-2">Aucun trajet à venir pour le moment</h3>
            <p className="text-white/70 mb-4">Soyez le premier à proposer un trajet ou modifiez vos critères de recherche.</p>
            <Link to="/publier" className="inline-block px-6 py-3 rounded-xl bg-demandoo-500 text-white font-bold hover:bg-demandoo-400 transition-colors">Proposer un trajet</Link>
          </div>
        ) : (
      ...
      {/* 4. COMMENT ÇA MARCHE */}
      <section id="comment-ca-marche" className="relative py-16 bg-transparent border-y border-white/10 z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
          <Reveal>
            <div className="space-y-4 max-w-2xl mx-auto">
              ...
              <p className="text-white/70 font-medium">Demandoo facilite la mise en relation. L’accord et le paiement se font directement entre le passager et le chauffeur.</p>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Reveal delay={100}>
              ...
              <div className="w-16 h-16 mx-auto rounded-2xl bg-white/10 backdrop-blur-md text-demandoo-400 flex items-center justify-center border border-white/10 shadow-lg">
                <Search className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-black text-white">1. Cherchez votre trajet</h3>
              <p className="text-white/70 text-sm font-medium">Choisissez votre destination et votre date parmi les trajets publiés.</p>
            </div>
            </Reveal>
            <Reveal delay={200}>
            <div className="space-y-4">
              ...
              <h3 className="text-xl font-black text-white">2. Contactez le chauffeur</h3>
              <p className="text-white/70 text-sm font-medium">Échangez directement avec le chauffeur par téléphone ou WhatsApp.</p>
            </div>
            </Reveal>
            <Reveal delay={300}>
            <div className="space-y-4">
              ...
              <h3 className="text-xl font-black text-white">3. Convenez du voyage</h3>
              <p className="text-white/70 text-sm font-medium">Confirmez ensemble la disponibilité, le lieu de rendez-vous et le prix (en espèces).</p>
            </div>
            </Reveal>
          </div>
        </div>
      ...
      <section className="relative py-16 bg-white/5 backdrop-blur-md border-y border-white/10 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <ShieldCheck className="w-12 h-12 text-emerald-400 mx-auto" />
          <h2 className="text-3xl font-black text-white">Des profils vérifiés</h2>
      ...
      {/* 7. TÉMOIGNAGES */}
      <section className="relative py-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <Reveal>
          <h2 className="text-3xl font-black text-white text-center mb-10">Ce qu'en disent nos utilisateurs</h2>
        </Reveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Reveal key={i} delay={i * 100}>
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-white/20 flex flex-col justify-between h-full hover:-translate-y-1 transition-transform">
                <div className="space-y-4 mb-6">
                  <div className="flex gap-1">
                    {[1,2,3,4,5].map(star => <Star key={star} className="w-4 h-4 fill-amber-400 text-amber-400" />)}
                  </div>
                  <p className="text-white/80 font-medium italic">"{testimonial.text}"</p>
                </div>
                <div className="flex items-center gap-3">
                  <img src={testimonial.img} alt={testimonial.name} className="w-10 h-10 rounded-full object-cover border-2 border-white/20 shadow-sm" />
                  <div>
                    <p className="font-black text-white">{testimonial.name}</p>
                    <p className="text-sm font-bold text-demandoo-400">{testimonial.role}</p>
                  </div>
                </div>
              </div>
            </Reveal>
      ...
      {/* 8. FAQ COURTE */}
      <section className="relative py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <Reveal>
        ...
        <div className="space-y-4">
          {[
            ...
            <Reveal key={i} delay={i * 100}>
              <div className="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/10 shadow-sm hover:border-white/30 transition-colors">
                <h3 className="font-black text-white flex items-center gap-2 mb-2"><HelpCircle className="w-4 h-4 text-demandoo-400 shrink-0" /> {faq.q}</h3>
                <p className="text-white/70 text-sm font-medium leading-relaxed pl-6">{faq.a}</p>
              </div>
            </Reveal>
          ))}
        </div>
      ...
      <section className="relative py-16 bg-transparent border-y border-white/10 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <Reveal>
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-md text-demandoo-400 mb-2 border border-white/10 shadow-lg">
            ...
            <h2 className="text-3xl font-black text-white mb-4">Emportez Demandoo partout avec vous</h2>
          ...
          <Reveal delay={150}>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
              {/* Bouton App Store */}
              <a href="#" onClick={(e) => e.preventDefault()} className="flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 py-3 rounded-xl hover:bg-white/20 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-1 transform w-full sm:w-auto justify-center">
              ...
              <a href="/demandoo.apk" download="demandoo.apk" className="flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 py-3 rounded-xl hover:bg-white/20 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-1 transform w-full sm:w-auto justify-center">
      ...
      <section id="abonnements" className="relative py-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <Reveal>
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-black text-white mb-4">Des offres adaptées à votre rythme</h2>
            <p className="text-white/70 font-medium">Zéro commission sur vos trajets. Vous payez uniquement l'abonnement qui correspond à vos besoins.</p>
          </div>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Découverte */}
          <Reveal delay={100}>
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 shadow-lg flex flex-col h-full hover:border-white/30 transition-colors">
              ...
              <p className="text-sm font-medium text-white/70 mb-6 flex-grow">Pour tester Demandoo et proposer votre premier trajet.</p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2 text-sm text-white/90 font-medium">✅ 1 trajet au total</li>
                <li className="flex items-center gap-2 text-sm text-white/90 font-medium">✅ Zéro commission</li>
              </ul>
              <Link to="/abonnement" className="w-full block text-center py-3 rounded-xl border border-white/30 font-bold text-white hover:bg-white/20 transition-colors">Commencer</Link>
            </div>
          </Reveal>

          {/* Standard */}
          <Reveal delay={200}>
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 shadow-xl flex flex-col h-full relative hover:border-white/30 transition-colors">
              <h3 className="text-xl font-bold text-white mb-2">Standard</h3>
              <div className="flex items-end gap-1 mb-4">
                <span className="text-4xl font-black text-white">2 400</span>
                <span className="text-lg font-bold text-white pb-1">FCFA</span>
                <span className="text-sm text-white/60 font-medium ml-1">/mois</span>
              </div>
              <p className="text-sm font-medium text-white/70 mb-6 flex-grow">Pour proposer quelques trajets occasionnels chaque mois.</p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2 text-sm text-white/90 font-medium">✅ Jusqu'à 4 trajets / mois</li>
                <li className="flex items-center gap-2 text-sm text-white/90 font-medium">✅ Zéro commission</li>
              </ul>
              <Link to="/abonnement" className="w-full block text-center py-3 rounded-xl bg-white/20 text-white font-bold hover:bg-white/30 backdrop-blur-md border border-white/30 transition-colors">Choisir Standard</Link>
            </div>
          </Reveal>

          {/* Pro */}
          <Reveal delay={300}>
            <div className="bg-demandoo-500/20 backdrop-blur-xl p-8 rounded-3xl border border-demandoo-400 shadow-2xl flex flex-col h-full relative md:-mt-4 md:mb-4">
              ...
              <p className="text-sm font-medium text-white/80 mb-6 flex-grow">Pour les chauffeurs qui roulent régulièrement.</p>
              <ul className="space-y-3 mb-8">
      ...
      <section className="relative bg-transparent border-t border-white/10 py-16 text-center px-4 z-10">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="pt-4">
            <Link to="/login" className="inline-block px-8 py-4 rounded-xl bg-demandoo-500 text-white font-black hover:bg-demandoo-400 transition-colors shadow-[0_0_20px_rgba(14,165,233,0.3)] hover:shadow-[0_0_30px_rgba(14,165,233,0.5)]">
              Devenir chauffeur
            </Link>
          </div>
        </div>
